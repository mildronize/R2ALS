...
def extract_grade_subject(grade_subject):
    if grade_subject is None:
        ...
        return "%s/%s: %s[%d]" % (grade_subject.year, grade_subject.semester, grade_subject.subject.short_name, grade_subject.subject.credit)
    return "%s/%s: %s[%d](%s)" % (grade_subject.year, grade_subject.semester, grade_subject.subject.short_name, grade_subject.subject.credit, grade_subject.grade.name)
