...
def apis_include(config):
    config.add_route('apis.solution_generator', '/solution-generator/')
...
def solution_generator_include(config):
    ...
    config.add_route('solution_generator.move_whole_chain','/move-whole-chain')
...
def add_routes(config):
    ...
    config.include(solution_generator_include, route_prefix='/solution-generator')
